...
#T.manual_seed(6970)##############################REMOOOOOVE AFTER USEEE#############################
#np.random.seed(421)##############################REMOOOOOVE AFTER USEEE#############################
...
class Agent():
    def __init__(self, alpha=0.0005, beta=0.0005, input_dims=[8],
            env=None, gamma=0.99, n_actions=2, max_size=100000, tau=0.001,
            layer1_size=32, layer2_size=32, batch_size=512, reward_scale=2):
        self.gamma = gamma
        self.tau = tau
